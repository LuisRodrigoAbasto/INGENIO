var Page = {
    ...
    tabBusqueda: async function () {
        await privilegios.MostrarBotones(`B`);
    ...
    tabDatos: async function () {
        await privilegios.MostrarBotones(`D`);
        Page.TabDatosPage();
    },
    ...
    RevisarSeguridad: async function () {
        ...
        await privilegios.MostrarBotones(tab);
        ...
        try {
            ...
            if (result.Result) {
                if (General.UsuarioTieneRolTxn("DATOS", result.Result.empId)) {
                    ...
                    Page.ObjToForm();
                    Page.ModoForm = "M";
                    if (Page.GetTabActive() != "tabBuscarLi") await privilegios.MostrarBotones(`D`);
    ...
    InitBotonesPredeterminados: (() => {
        ...
        $("#btnBuscar, #btnCelBuscar").click(function () {
            Page.Buscar();
        });

        $(`#btnCelTabAtras`).click(function () {
            Page.TabCambiarPageCelAtras();
        });

        $(`#btnCelTabAdelante`).click(function () {
            Page.TabCambiarPageCelAdelante();
        });
